...
namespace Money.Storage.NHibernate
{
    ...
    /// </summary>
    /// <remarks>
    /// Source: MavenThought.MediaLibrary.Storage.NHibernate.SessionHelper
    ///         https://github.com/amirci/webacceptance_mvcconf_feb11/tree/master/main/MavenThought.MediaLibrary.Storage.NHibernate
    /// </remarks>
    public static class SessionHelper
    {
        ...
        /// <remarks>Based on: MavenThought.Commons</remarks>
        public static void ForEach<T>(this IEnumerable items, Action<T> action)
        {
            items.Cast<T>().ForEach(action);
        }
        ...
        {
            return factory.AutoSession(s => 
                s.CreateCriteria(typeof(T)).List<T>());
        }
